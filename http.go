...
// generateFile generates a _hertz.pb.go file containing Hertz errors definitions.
...
// generateFileContent generates the Hertz errors definitions, excluding the package statement.
func generateFileContent(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, omitempty bool, omitemptyPrefix string) {
	...
	g.P("var _ = new(", netHttpPkg.Ident("Handler"), ")")
	g.P("var _ = new(", xhertzPkg.Ident("Error"), ")")
